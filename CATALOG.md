...
### http://test-network-function.com/testcases/access-control/container-is-certified

Property|Description
---|---
Version|v1.0.0
Description|http://test-network-function.com/testcases/access-control/container-is-certified tests whether container images have passed the Red Hat Container Certification Program (CCP).
Result Type|normative
